          ...
          return (
            ...
            >
              <div className="min-w-0">
                ...
                <p className="text-base text-[#0C0C0C]">{phone}</p>
                <p
                  className={`text-base mt-0.5 ${
                    businessTypeStyles[businessType] ?? "text-[#0C0C0C]"
                  }`}
                >
                  {businessType}
                </p>
                <p className="text-base text-[#242424]">{pageName}</p>
                <p className="text-base text-[#0C0C0C]">{date}</p>
              </div>
