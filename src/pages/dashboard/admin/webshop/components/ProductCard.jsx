...
function ProductCard({ product, onView, onEdit, onDelete }) {
  ...
  return (
    <div
      ...
      className='border border-[#e2ab0b]/30 rounded-2xl p-4 flex flex-col gap-6 bg-white cursor-pointer h-full'
    >
      {/* Product image */}
      ...
      <div className='flex flex-col gap-4 flex-1'>
        ...
        <div className='flex gap-4'>
          <button
            ...
            className='flex-1 flex items-center justify-center gap-2.5 bg-[#E2AB0B] text-white px-6 py-3 rounded text-base font-normal transition-colors hover:bg-[#c99809] cursor-pointer'
          >
            <Pencil size={18} />
            Edit
          </button>
