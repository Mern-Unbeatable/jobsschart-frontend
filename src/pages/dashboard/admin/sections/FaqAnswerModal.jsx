        ...
        <div className="sticky bottom-0 z-20 bg-white border-t border-[#ede9f2] px-4 py-3 sm:px-8 sm:py-4">
          <div className="flex justify-end">
            <button
              type="button"
              onClick={onPublish}
              className="inline-flex items-center gap-2 rounded-lg bg-green-500/60 px-5 py-3 text-sm font-semibold text-white shadow-sm transition-all hover:brightness-95"
            >
