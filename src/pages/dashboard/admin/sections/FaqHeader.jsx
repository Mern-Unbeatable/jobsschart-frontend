  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
      ...
      <button
        type="button"
        onClick={onAddNew}
        className="inline-flex items-center gap-2 self-start rounded-lg bg-green-500/60 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-all hover:brightness-95"
      >
