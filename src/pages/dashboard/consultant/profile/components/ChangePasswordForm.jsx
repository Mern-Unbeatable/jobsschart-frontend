...
export default function ChangePasswordForm({ passwordForm, onChange, onSubmit }) {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        <div className="space-y-3">
          <label htmlFor="new-password" className="block text-base text-[#464646]">
            New Password
          </label>
          <input
            id="new-password"
        ...
        <div className="space-y-3">
          <label htmlFor="confirm-password" className="block text-base text-[#464646]">
