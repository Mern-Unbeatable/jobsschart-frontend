        ...
        {step === "select" ? (
          <div className="w-full max-w-md space-y-6">
            <div className="text-center mb-10">
              <div className="flex justify-center mb-3">
                <div className="bg-[#FEF5E7] p-3 rounded-lg">
                  <Briefcase className="text-green-500/60" />
                </div>
              </div>
            ...
            <p className="text-center text-base text-gray-500 mt-4">
              ...
              <Link to={ROUTES.LOGIN} className="text-black font-bold ml-1">
                Login
              </Link>
            </p>
          </div>
          ...
          <div className="w-full max-w-xl py-8">
            <div className="flex items-center justify-between mb-4">
              <button
                ...
                className="flex items-center text-gray-500 hover:text-green-500/60 text-base font-medium"
              >
              ...
              <Link
                to={ROUTES.HOME}
                className="text-gray-500 hover:text-green-500/60 text-base font-medium"
              >
                Back to Home
              </Link>
            </div>
