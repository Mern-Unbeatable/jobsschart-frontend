  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {blogs.map((blog) => (
        <div
          key={blog.id}
          className="group bg-white rounded-xl border border-green-500/60 p-2 shadow-sm hover:shadow-md transition-shadow flex flex-col h-full"
        >
          ...
          <div className="px-2 pb-2 flex flex-col flex-1">
            ...
            <h3 className="text-2xl font-medium text-gray-800 mb-3 leading-snug group-hover:text-green-500/60 transition-colors line-clamp-2">
              {blog.title}
            </h3>
            ...
            <button
              ...
              className="w-full bg-green-500/60  text-white py-2.5 rounded-md text-sm flex items-center justify-center gap-2 transition-colors shadow-sm uppercase tracking-wider mt-auto"
            >
