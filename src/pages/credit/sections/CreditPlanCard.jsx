    ...
    <div className="rounded-xl bg-white p-6 border border-[#00000033] flex flex-col justify-start h-full">
      <div>
        ...
        <button
          ...
          className="w-full bg-green-500/60 hover:bg-green-500/80 text-white py-3 rounded-md font-semibold mb-4 transition duration-200 shadow-sm font-poppins disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isCheckingOut ? (
