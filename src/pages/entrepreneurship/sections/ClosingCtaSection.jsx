...
const ClosingCtaSection = memo(() => {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6  lg:py-20">
      ...
      <div className="rounded-3xl bg-[#F5F1FD] px-6 py-12 text-center sm:px-12 sm:py-16">
        {/* Title */}
        ...
        <div className="mt-6 flex justify-center">
          <Link
            ...
            className="rounded bg-[#6E35AE] px-6 py-2.5 text-xs font-medium text-white transition-transform hover:-translate-y-0.5"
          >
            {t(
