...
import { X, Check, Star, Phone } from 'lucide-react';
...
const CallFeedbackModal = memo(({ consultant, seconds, totalCost, callId, onClose }) => {
    ...
    const durationDisplay = formatSessionDuration(seconds);
    const chargedAmount = totalCost != null
        ? Number(totalCost).toFixed(2)
        : Number(((seconds || 0) / 60) * ratePerMinute).toFixed(2);
                ...
                <div className='flex flex-col items-center p-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] sm:p-8'>
                    ...
                    <div className='grid grid-cols-3 gap-3 w-full mb-6'>
                        ...
                        <div className='bg-white/10 rounded-xl py-3 px-1 text-center border border-white/5'>
                            ...
                            <p className='text-white font-bold text-lg'>€{chargedAmount}</p>
                        </div>
                        <div className='bg-white/10 rounded-xl py-3 px-1 text-center border border-white/5'>
