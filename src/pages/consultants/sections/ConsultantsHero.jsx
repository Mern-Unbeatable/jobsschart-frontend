            ...
            <div className="flex flex-col md:flex-row gap-4 items-stretch">
              ...
              <div className="relative w-full md:w-64">
                <select
                  ...
                  className="w-full appearance-none px-5 py-4 rounded-xl bg-[#FCF7E7] text-gray-700 font-medium border border-white/20 shadow-lg focus:outline-none focus:ring-2 focus:ring-green-500/60/50"
                >
              ...
              <div className="relative w-full md:flex-1">
                ...
                <input
                  ...
                  className="w-full pl-14 pr-5 py-4 rounded-xl bg-[#FCF7E7] text-gray-700 placeholder-gray-500 border border-white/20 shadow-lg focus:outline-none focus:ring-2 focus:ring-green-500/60/50"
                />
              </div>
