      ...
      <div className="relative shrink-0">
        ...
        <span
          ...
          className={`absolute bottom-0.5 right-0.5 h-2.5 w-2.5 rounded-full border-2 border-white ${
            STATUS_DOT[conversation.status] || "bg-gray-400"
          }`}
        />
      </div>
        ...
        >
          <div className="flex items-center gap-3 px-4 h-20 bg-gray-200 shrink-0 border-b border-gray-100">
            ...
            <div className="relative shrink-0">
              ...
              <span
                aria-hidden="true"
                className={`absolute bottom-0 right-0 h-2.5 w-2.5 rounded-full border-2 border-[#eeeeee] ${
                  activeConv?.contactOnline ? "bg-green-500" : "bg-gray-400"
                }`}
              />
            </div>
