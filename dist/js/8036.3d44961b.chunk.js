...
(self.webpackChunkreact_webpack_tailwind_app =
  ...
  [8036],
  {
            ...
            function () {
              var e = (function (e) {
                var t = e.title,
                  ...
                  y = o.l8.DEFAULT_TITLE;
                return {
                  title: t ? "".concat(t, " | ").concat(y) : y,
                  description: r,
                  keywords: a.join(", "),
                  canonical: b,
                  openGraph: {
                    ...
                    t.forEach(function (e) {
                      ...
                      if (n) {
                        ...
                        (a ||
                          ...
                          r && a.setAttribute("property", r),
                          document.head.appendChild(a)),
                          a.setAttribute("content", n));
                      }
                    }));
                  var r =
    ...
    18036(e, t, r) {
              ...
              (0, s.jsx)("div", {
                ...
                children: (0, s.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, s.jsx)("button", {
                      className:
                        "bg-[#EAB308] cursor-pointer text-white px-6 py-3 rounded-sm font-medium text-sm sm:text-base transition-all duration-300 shadow-md active:scale-95",
      ...
      var A = (0, n.memo)(function (e) {
        var t = e.formData,
          r = e.setFormData,
          n = (0, a.Bd)().t,
          o = "business" === t.donorType;
        return (0, s.jsxs)("div", {
            ...
            (0, s.jsxs)("div", {
              ...
              children: [
                (0, s.jsx)("h2", {
                  ...
                  children: n("donationForm.header.title"),
                }),
                (0, s.jsx)("p", {
                  className: "text-gray-500 text-base",
                  children: n("donationForm.header.subtitle"),
                }),
              ],
            }),
            (0, s.jsxs)("div", {
              ...
              children: [
                (0, s.jsx)("p", {
                  ...
                  children: n("donationForm.quote"),
                }),
                (0, s.jsx)("p", {
                  className: "text-gray-400 text-base",
                  children: n("donationForm.attribution"),
                }),
              ],
            }),
            (0, s.jsxs)("div", {
                ...
                (0, s.jsxs)("div", {
                  ...
                  children: [
                    (0, s.jsx)("h3", {
                      ...
                      children: n("donationForm.formHeader.title"),
                    }),
                    (0, s.jsx)("p", {
                      className: "text-gray-500 text-base",
                      children: n("donationForm.formHeader.subtitle"),
                    }),
                  ],
                }),
                (0, s.jsx)("div", {
                    ...
                    children: [
                          ...
                          (0, s.jsxs)("div", {
                            children: [
                              (0, s.jsx)("label", {
                                ...
                                children: n("donationForm.fields.name.label"),
                              }),
                              (0, s.jsx)("input", {
                                type: "text",
                                placeholder: n(
                                ...
                                className:
                                  "w-full px-4 py-3 border border-gray-200 rounded-md text-sm focus:outline-none focus:border-[#EAB308]",
                                value: t.name,
                                onChange: function (e) {
                                  return r(
                                    w(w({}, t), {}, { name: e.target.value }),
                                  );
                                },
                              }),
                            ],
                          ...
                          (0, s.jsxs)("div", {
                            children: [
                              (0, s.jsx)("label", {
                                className:
                                  "block text-base  text-gray-600 mb-2",
                                children: n("donationForm.fields.amount.label"),
                              }),
                              (0, s.jsx)("input", {
                                type: "number",
                                placeholder: n(
                      ...
                      (0, s.jsxs)("div", {
                        ...
                        children: [
                          (0, s.jsx)("label", {
                            ...
                            children: n("donationForm.donorType.label"),
                          }),
                          (0, s.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, s.jsxs)("button", {
                                ...
                                onClick: function () {
                                  return r(
                                    w(w({}, t), {}, { donorType: "business" }),
                                  );
                                },
                                className:
                                  "flex-1 py-6 rounded-lg border-2 flex flex-col items-center gap-2 transition-all ".concat(
                                    "business" === t.donorType
                          ...
                          children: [
                              ...
                              children: [
                                (0, s.jsxs)("button", {
                                  ...
                                  children: [
                                    (0, s.jsx)(y.A, { size: 12 }),
                                    " ",
                                    n("donationForm.businessType.local"),
                                  ],
                                }),
                                (0, s.jsxs)("button", {
                                  type: "button",
                                  ...
                                  children: [
                                    (0, s.jsx)(f.A, { size: 12 }),
                                    " ",
                                    n("donationForm.businessType.online"),
                                  ],
                                }),
                              ],
                            }),
                            ...
                            (0, s.jsxs)("div", {
                              children: [
                                (0, s.jsx)("label", {
                                  ...
                                  children:
                                    "online" === t.businessType
                                      ? n("donationForm.fields.website.label")
                                      : n("donationForm.fields.location.label"),
                                }),
                                (0, s.jsxs)("div", {
                                  className: "relative",
                                  children: [
                            ...
                            (0, s.jsxs)("div", {
                              children: [
                                ...
                                (0, s.jsxs)("div", {
                                  className:
                                    "border-2 border-dashed border-gray-200 rounded-xl p-8 flex flex-col items-center justify-center gap-3 bg-white hover:border-[#EAB308] cursor-pointer transition-colors",
                                  children: [
                                    (0, s.jsx)(h.A, {
                                      size: 28,
                          ...
                          (0, s.jsxs)("div", {
                            ...
                            children: [
                              ...
                              (0, s.jsx)("h4", {
                                ...
                                children: n("donationForm.benefits.title"),
                              }),
                            ],
                          }),
                          (0, s.jsxs)("div", {
                      ...
                      (0, s.jsx)("div", {
                        ...
                        children: (0, s.jsx)("button", {
                          className:
                            "bg-[#EAB308] hover:bg-[#d99a00] text-white text-sm font-bold py-3 px-8 rounded  transition-all active:scale-95",
                          children: n("donationForm.button", {
                            amount: t.amount || "100",
                          }),
                        }),
                      }),
      ...
      A.displayName = "DonationFormSection";
      const k = A;
      var E = r(29673);
      function T(e, t) {
        ...
        return (
          ...
          (0, s.jsxs)("div", {
            ...
            children: [
              (0, s.jsx)(l, {}),
              (0, s.jsx)(x, {}),
              (0, s.jsx)(k, { formData: a, setFormData: i }),
              (0, s.jsx)(E.A, {
                containerClassName:
