                      ...
                      children: (0, r.jsxs)("form", {
                        children: [
                          ...
                          (0, r.jsx)("button", {
                            type: "submit",
                            className:
                              "mt-6 w-full rounded-md bg-green-500/60 px-4 py-3 text-sm font-semibold text-white hover:bg-[#e5a834] transition-colors",
