      ...
      const p = function () {
        var e = u((0, a.useState)(m), 2),
          ...
          p = function (e) {
            return function (r) {
              (t(function (t) {
                return i(i({}, t), {}, c({}, e, r.target.value));
              }),
                l[e] &&
                  d(function (r) {
                    return i(i({}, r), {}, c({}, e, ""));
          ...
          children: [
            (0, n.jsxs)("div", {
              children: [
                ...
                (0, n.jsx)("p", {
                  ...
                  children: "Super Administrator • Full Access",
                }),
              ],
            }),
            (0, n.jsxs)("div", {
              ...
              children: [
                ...
                (0, n.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, n.jsx)("input", {
                      ...
                      onChange: p("fullName"),
                      className:
                        "w-full px-4 py-2.5 border border-gray-200 rounded-lg text-base text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-amber-400",
                    }),
                    l.fullName &&
                      (0, n.jsx)("p", {
                ...
                (0, n.jsxs)("div", {
                  ...
                  children: [
                    (0, n.jsx)("label", {
                      className: "text-base font-medium text-gray-700",
                      children: "Changes Password",
                    }),
                    (0, n.jsx)("input", {
                      type: "password",
                      placeholder: "changes your password",
                      value: r.newPassword,
                      onChange: p("newPassword"),
            ...
            (0, n.jsx)("div", {
              ...
              children: (0, n.jsx)("button", {
                ...
                onClick: function () {
                  var e = (function () {
                    ...
                    return (
                      ...
                      (r.password.trim() || r.newPassword.trim()) &&
                        (r.password.trim() ||
                          (e.password =
                            "Current password is required to set a new one"),
                        r.newPassword.trim()
                          ? r.newPassword.trim().length < 8 &&
                            (e.newPassword =
                  ...
                  Object.keys(e).length > 0
                    ? d(e)
                    : (s.Ay.success("Profile updated successfully"),
                      t(function (e) {
                        return i(
                          i({}, e),
                          {},
                ...
                className:
                  "px-6 py-2.5 bg-amber-500  text-white text-base font-semibold rounded-lg transition-colors",
