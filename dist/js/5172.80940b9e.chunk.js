    ...
    35172(e, t, r) {
      ...
      function k(e) {
        ...
        return (0, p.jsxs)("div", {
          ...
          className:
            "border border-green-500/60/30 rounded-2xl p-4 flex flex-col gap-6 bg-white cursor-pointer",
          children: [
            (0, p.jsx)("div", {
              className:
                "w-full h-48 sm:h-56 lg:h-64 rounded-lg overflow-hidden shrink-0",
              ...
              children: [
                (0, p.jsxs)("div", {
                  ...
                  children: [
                    (0, p.jsx)("h3", {
                      className:
                        "text-xl font-medium text-[#333] leading-tight",
                      style: { fontFamily: "'Crimson Pro', Georgia, serif" },
                      children: t.name,
                    }),
                    (0, p.jsx)("p", {
                      className:
                        "text-sm text-[#545454] leading-relaxed line-clamp-3",
                  ...
                  children: [
                    (0, p.jsxs)("button", {
                      ...
                      onMouseEnter: function () {
                        return m.os.to(s.current, {
                          scale: 1.03,
                          duration: 0.13,
                        });
                      },
                      onMouseLeave: function () {
                        return m.os.to(s.current, { scale: 1, duration: 0.13 });
                      },
                      className:
                        "flex-1 flex items-center justify-center gap-2.5 bg-green-500/60 text-white px-6 py-3 rounded text-base font-normal transition-colors hover:bg-[#c99809]",
                      children: [(0, p.jsx)(c.A, { size: 18 }), "Edit"],
                    }),
                    (0, p.jsxs)("button", {
                      ref: l,
                      onClick: function (e) {
                      ...
                      onMouseEnter: function () {
                        return m.os.to(l.current, {
                          scale: 1.03,
                          duration: 0.13,
                        });
                      },
                      onMouseLeave: function () {
                        return m.os.to(l.current, { scale: 1, duration: 0.13 });
                      },
                      className:
                        "flex-1 flex items-center justify-center gap-2.5 border border-[#6E35AE] text-[#6E35AE] px-6 py-3 rounded text-base font-normal transition-colors hover:bg-[#6E35AE]/5",
                      children: [(0, p.jsx)(d.A, { size: 18 }), "Delete"],
                    }),
                  ],
                }),
              ],
      ...
      const C = function () {
        var e = (0, u.Zp)(),
          t = g((0, n.useState)(A), 2),
          r = t[0],
          c = t[1],
          d = g((0, n.useState)("All"), 2),
          x = d[0],
          b = d[1],
          h = g((0, n.useState)(1), 2),
          y = h[0],
          w = h[1],
          v = g((0, n.useState)(null), 2),
          C = v[0],
          E = v[1],
          S = (0, n.useRef)(null),
          B = (0, n.useRef)([]);
        (0, n.useEffect)(
          function () {
            if (S.current) {
              var e = S.current.querySelectorAll("[data-card]");
              m.os.fromTo(
                e,
                { opacity: 0, y: 16 },
                {
        ...
        var D,
          ...
          _ = Math.max(1, Math.ceil(I.length / 8)),
          z = I.slice(8 * (y - 1), 8 * y),
          H =
            ((D = y),
            (P = _) <= 5
              ? Array.from({ length: P }, function (e, t) {
                  return t + 1;
                })
              : D <= 3
                ? [1, 2, 3, "...", P]
        ...
        return (0, p.jsxs)("div", {
          ...
          children: [
                ...
                (0, p.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, p.jsx)("p", {
                      ...
                      children:
                        "Overview & manage your products, orders, and online store activity.",
                    }),
                  ],
                }),
                (0, p.jsxs)("button", {
                  onClick: function () {
                    return e(f.bw.ADMIN_WEBSHOP_ADD_PRODUCT);
                  },
                  className:
                    "shrink-0 flex items-center gap-2 bg-green-500/60 text-white px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-[#c99809] transition-colors",
                  children: [(0, p.jsx)(l.A, { size: 16 }), "Add New Products"],
                }),
              ],
            }),
            (0, p.jsx)("div", {
              ...
              children: j.map(function (e, t) {
                return (0, p.jsx)(
                  "button",
                  {
                    ...
                    onMouseEnter: function () {
                      e !== x &&
                        m.os.to(B.current[t], { scale: 1.04, duration: 0.13 });
                    },
                    onMouseLeave: function () {
                      return m.os.to(B.current[t], {
                        scale: 1,
                        duration: 0.13,
                      });
                    },
                    className:
                      "px-3 py-1.5 rounded-full text-base font-normal transition-colors ".concat(
                        x === e
                          ? "bg-[#333] text-white"
            ...
            0 === z.length
              ? (0, p.jsx)("div", {
                  className: "py-24 text-center text-base text-gray-400",
                    ...
                    return (0, p.jsx)(
                      "div",
                      {
                        ...
                        children: (0, p.jsx)(k, {
                          ...
                          onView: function () {
                            return e(
                              f.bw.ADMIN_WEBSHOP_PRODUCT_VIEW.replace(
                                ":productId",
                                t.id,
                              ),
                              { state: { product: t } },
              ...
              (0, p.jsxs)("div", {
                ...
                children: [
                  (0, p.jsx)("button", {
                    ...
                    disabled: 1 === y,
                    className:
                      "w-9 h-9 flex items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors",
                    "aria-label": "First page",
                    children: (0, p.jsx)(o.A, { size: 14 }),
                  }),
                  (0, p.jsx)("button", {
                    onClick: function () {
                      return w(function (e) {
                  ...
                  H.map(function (e, t) {
                    return "..." === e
                      ? (0, p.jsx)(
                          ...
                          {
                            className:
                              "w-9 h-9 flex items-center justify-center text-sm text-gray-400 select-none",
                            children: "...",
                          },
                          "ellipsis-".concat(t),
                        )
                      : (0, p.jsx)(
                          "button",
                          {
                            ...
                            className:
                              "w-9 h-9 flex items-center justify-center rounded-full border text-sm font-semibold transition-colors ".concat(
                                y === e
                                  ? "bg-green-500/60 border-green-500/60 text-white"
                                  : "border-gray-200 bg-white text-[#333] hover:bg-gray-50",
                              ),
                            "aria-label": "Page ".concat(e),
                            "aria-current": y === e ? "page" : void 0,
                            children: e,
                          },
                          e,
                        );
