...
(self.webpackChunkreact_webpack_tailwind_app =
  ...
  [1634],
  {
    29673(e, t, r) {
      ...
      var a = r(96540),
        ...
        l = (0, a.memo)(function (e) {
          var t = e.wrapperClassName,
            ...
            l = void 0 === a ? "container mx-auto px-4 lg:px-6" : a;
          return (0, s.jsx)("div", {
            className: r,
      ...
      l.displayName = "CommonAdsSection";
      const n = l;
    },
    1634(e, t, r) {
      ...
      var x = (0, a.memo)(function () {
        ...
        return (0, o.jsx)("div", {
          className: "min-h-screen bg-white pt-8 md:pt-12 pb-14 mb:pb-20",
                ...
                children: [
                  (0, o.jsxs)("div", {
                    children: [
                      (0, o.jsx)("div", {
                        className:
                          "rounded-2xl overflow-hidden border border-gray-100 shadow-sm mb-4",
                      ...
                      (0, o.jsx)("div", {
                        ...
                        children: g.gallery.map(function (e, t) {
                          return (0, o.jsx)(
                            "div",
                            {
                              className:
                                "aspect-square rounded-lg overflow-hidden border-2 cursor-pointer hover:border-[#D9A108] transition-all ".concat(
                                  h === t
                                    ? "border-[#D9A108]"
                                    : "border-gray-200",
                                ),
                  ...
                  (0, o.jsxs)("div", {
                    ...
                    children: [
                      (0, o.jsx)("h1", {
                        className:
                          "text-2xl md:text-3xl font-bold text-gray-800 mb-1 ",
                        children: g.name,
                      }),
                      (0, o.jsx)("p", {
                      ...
                      (0, o.jsxs)("div", {
                        className: "text-3xl font-bold text-green-500/60 mb-2 ",
                        children: ["€", g.price.toFixed(2)],
                      }),
                      (0, o.jsx)("h3", {
                        className:
                      ...
                      (0, o.jsx)("ul", {
                        ...
                        children: g.features.map(function (e, t) {
                          return (0, o.jsxs)(
                            "li",
                            {
                              className:
                      ...
                      (0, o.jsxs)("div", {
                        ...
                        children: [
                          (0, o.jsxs)("div", {
                            className:
                              "flex items-center border border-gray-300 rounded-md h-12",
                            children: [
                              (0, o.jsx)("button", {
                                onClick: function () {
                                  return x(function (e) {
                                ...
                                className:
                                  "px-3 text-gray-500 hover:text-black",
                                children: (0, o.jsx)(n.A, { size: 16 }),
                              }),
                              (0, o.jsx)("span", {
                                className: "px-4 font-bold text-gray-700",
                                children: m,
                              }),
                              (0, o.jsx)("button", {
                                onClick: function () {
                          ...
                          (0, o.jsx)("button", {
                            onClick: function () {
                              return t("/checkout", {
                                state: { product: g, quantity: m },
                              });
                            },
                            className:
                              "flex-1 bg-green-500/60 text-white font-bold h-12 rounded-md shadow-sm transition-all text-base hover:bg-[#d99a00]",
                            children: "Buy Now",
                          }),
                        ],
                      }),
                ...
                children: [
                  (0, o.jsxs)("div", {
                    children: [
                      ...
                      (0, o.jsx)("div", {
                        ...
                        children: g.whatsInside.map(function (e, t) {
                          return (0, o.jsx)(
                            "span",
                            {
                              className:
                                "px-5 py-2.5 bg-[#F2F2F2] text-gray-600 rounded-lg text-base font-medium",
                              children: e,
                            },
                            t,
                          );
                  ...
                  (0, o.jsxs)("div", {
                    children: [
                      ...
                      (0, o.jsx)("div", {
                        className: "flex flex-wrap gap-2",
                        children: g.benefits.map(function (e, t) {
                          return (0, o.jsx)(
                            "span",
                            {
                              className:
