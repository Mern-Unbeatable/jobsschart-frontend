    ...
    67980(e, t, s) {
      ...
      const c = function () {
          ...
          return (0, a.jsxs)("section", {
            ...
            children: [
              (0, a.jsxs)("div", {
                className:
                  "flex items-center gap-2 text-2xl font-semibold text-[#5c3d91] ",
                children: [
                  (0, a.jsx)(r.A, { size: 18, "aria-hidden": "true" }),
                ...
                children: l.map(function (e) {
                  ...
                  return (0, a.jsxs)(
                    "button",
                    {
                      type: "button",
                      onClick: function () {
                        return d(t ? null : e.id);
                      },
                      className:
                        "w-full rounded-lg border border-gray-100 bg-white px-4 py-4 text-left shadow-[0_1px_8px_rgba(15,23,42,0.04)] transition-all hover:border-[#e3d7f7]",
                      children: [
                        (0, a.jsxs)("div", {
                          ...
                          children: [
                            (0, a.jsx)("span", {
                              className:
                                "text-base font-semibold text-[#2f2f2f] sm:text-base",
                              children: e.question,
                            }),
                            (0, a.jsx)(i.A, {
                              size: 18,
                              className:
                                "shrink-0 text-[#b39ddb] transition-transform ".concat(
                                  t ? "rotate-180" : "",
                                ),
                              "aria-hidden": "true",
                            }),
                        ...
                        t &&
                          (0, a.jsx)("p", {
                            className:
                              "mt-3 max-w-3xl text-base leading-6 text-gray-500",
                            children: e.answer,
                          }),
                      ],
                    },
        ...
        d = function () {
          return (0, a.jsxs)("section", {
            className:
              "mt-4 rounded-lg bg-[#8f6bc8] p-4 text-white shadow-[0_20px_40px_rgba(109,78,166,0.2)] sm:p-6 lg:p-7",
            children: [
              (0, a.jsxs)("div", {
                className: "max-w-2xl",
                children: [
                  (0, a.jsx)("h2", {
                    ...
                    children: "Can't find your answer?",
                  }),
                  (0, a.jsx)("p", {
                    className:
                      "mt-2 text-base leading-6 text-white/80 sm:text-base",
                    children:
              ...
              (0, a.jsx)("div", {
                className:
                  "mt-5 rounded-lg bg-white/10 p-4 backdrop-blur-[1px] sm:p-5",
                  ...
                  children: [
                    (0, a.jsxs)("label", {
                      ...
                      children: [
                        (0, a.jsx)("span", {
                          className:
                            "block text-base  uppercase tracking-wider text-white",
                          children: "Subject",
                        }),
                        (0, a.jsx)("input", {
                          type: "text",
                          ...
                          className:
                            "h-12 w-full rounded-md border-0 bg-white/25 px-4 text-sm text-white placeholder:text-white/55 outline-none ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-white/40",
                        }),
                      ],
                    }),
                    (0, a.jsxs)("label", {
                      ...
                      children: [
                        ...
                        (0, a.jsx)("textarea", {
                          ...
                          className:
                            "w-full rounded-md border-0 bg-white/25 px-4 py-3 text-sm text-white placeholder:text-white/55 outline-none ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-white/40",
                        }),
                      ],
                    }),
                    (0, a.jsx)("button", {
                      type: "button",
                      className:
                        "h-12 rounded-md bg-green-500/60 text-sm  text-white transition-all ",
      ...
      const f = function (e) {
        var t = e.ticket,
          ...
          n = e.onClose;
        if (!s || !t) return null;
        var r = h[t.id] || h["TK-SAP"],
          i = function (e) {
            return e.split(/(\*\*.*?\*\*)/g).map(function (e, t) {
        ...
        return (0, a.jsx)("div", {
          ...
          children: (0, a.jsxs)("div", {
            className:
              "w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-[20px] bg-white shadow-2xl",
            children: [
              (0, a.jsxs)("div", {
                className: "sticky top-0 bg-white px-8 pt-8 pb-6",
                children: [
                  (0, a.jsxs)("button", {
                    type: "button",
                    onClick: n,
                    className:
                      "inline-flex items-center gap-2 text-[15px] font-medium text-[#6B4E90] transition-colors hover:text-[#4A3564]",
                    children: [
                      (0, a.jsx)(x.A, { size: 18, "aria-hidden": "true" }),
                      "Back to Tickets",
                    ],
                  }),
                  (0, a.jsx)("div", {
                    className: "mt-6 h-[1px] w-full bg-gray-100",
                  }),
                ],
              }),
              (0, a.jsxs)("div", {
                className: "space-y-8 px-8 pb-10 pt-2",
                children: [
                  (0, a.jsxs)("section", {
                    children: [
                      (0, a.jsxs)("div", {
                        ...
                        children: [
                          (0, a.jsx)("div", {
                            className:
                              "flex h-6 w-6 items-center justify-center rounded-[4px] bg-[#6B4E90] text-sm font-bold text-white shadow-sm",
                            children: "?",
                          }),
                          (0, a.jsx)("h2", {
                            className: "text-[19px] font-medium text-gray-900",
                      ...
                      (0, a.jsxs)("div", {
                        className:
                          "flex overflow-hidden rounded-xl bg-[#F8F9FA]",
                        children: [
                          (0, a.jsx)("div", {
                            className: "w-[5px] shrink-0 bg-[#6B4E90]",
                          }),
                          (0, a.jsx)("div", {
                            className:
                              "p-5 text-[15px] italic leading-relaxed text-[#5A5A5A]",
                            children: r.question,
                          }),
                        ],
                      }),
                  ...
                  (0, a.jsxs)("section", {
                    children: [
                      (0, a.jsxs)("div", {
                        className:
                          "mb-5 flex items-baseline justify-between gap-4",
                        children: [
                          (0, a.jsx)("h3", {
                            className:
                              "text-[26px] font-bold tracking-tight text-gray-900",
                            style: {
                              fontFamily:
                                'ui-serif, Georgia, Cambria, "Times New Roman", Times, serif',
                            },
                            children: r.response.title,
                          }),
                          (0, a.jsx)("p", {
                            className:
                              "whitespace-nowrap text-[13px] font-medium text-gray-500",
                            children: r.response.date,
                          }),
                        ],
                      }),
                      (0, a.jsx)("div", {
                        className: "text-[15px] leading-relaxed text-[#4A4A4A]",
                        children: r.response.content
                          .split("\n")
                          .map(function (e, t, s) {
                            var n =
                                e.startsWith("**") &&
                            ...
                            return n
                              ? (0, a.jsx)(
                                  "p",
                                  {
                                    className: "mt-5 mb-2 text-gray-900",
                                    children: i(e),
                                  },
                                  t,
                                )
      ...
      const w = function () {
          var e = p((0, n.useState)(null), 2),
            t = e[0],
            s = e[1],
            r = p((0, n.useState)(!1), 2),
            i = r[0],
            o = r[1];
            ...
            children: [
              (0, a.jsxs)("section", {
                ...
                children: [
                  (0, a.jsx)("h2", {
                    className:
                      "text-xl font-semibold text-[#2f2f2f] sm:text-2xl",
                    ...
                    children: b.map(function (e) {
                      return (0, a.jsx)(
                        "button",
                        {
                          ...
                          children: (0, a.jsxs)("div", {
                            className:
                              "flex items-center justify-between gap-4 rounded-lg border border-gray-100 bg-white px-4 py-4 shadow-[0_1px_8px_rgba(15,23,42,0.04)]",
                            children: [
                              (0, a.jsxs)("div", {
                                ...
                                children: [
                                  (0, a.jsx)("div", {
                                    className:
                                      "mt-0.5 flex size-10 shrink-0 items-center justify-center rounded-full bg-[#f2ecfb] text-[#7a5ab6]",
                                  ...
                                  (0, a.jsxs)("div", {
                                    ...
                                    children: [
                                      (0, a.jsx)("h3", {
                                        className:
                                          "truncate text-base font-semibold text-[#2f2f2f] sm:text-base",
                                        children: e.title,
                                      }),
                                      (0, a.jsx)("p", {
                                        className:
                                          "mt-1 text-sm text-gray-400 sm:text-sm",
                                        children: e.meta,
                                      }),
                                    ],
                                  }),
                              ...
                              (0, a.jsxs)("div", {
                                ...
                                children: [
                                  (0, a.jsx)("span", {
                                    className:
                                      "rounded-full px-3 py-1 text-xs font-semibold uppercase tracking-wide ".concat(
                                        g[e.status],
                                      ),
                                    children: e.status,
                                  }),
            ...
            children: [
              (0, a.jsxs)("div", {
                children: [
                  (0, a.jsx)("h1", {
                    className:
                      "text-2xl font-semibold text-[#2f2f2f] sm:text-3xl",
                    children: "Support Tickets",
                  }),
                  (0, a.jsx)("p", {
                    className: "mt-1 text-sm text-gray-500 sm:text-base",
                    children: "Feel free to solve your doubts anytime",
                  }),
                ],
              }),
              (0, a.jsx)(c, {}),
