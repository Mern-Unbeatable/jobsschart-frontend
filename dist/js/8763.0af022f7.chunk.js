...
(self.webpackChunkreact_webpack_tailwind_app =
  ...
  [8763],
  {
    28763(e, t, r) {
              ...
              (0, c.jsxs)("div", {
                ...
                children: [
                  (0, c.jsxs)("button", {
                    ...
                    children: [(0, c.jsx)(a.A, { size: 14 }), "Edit"],
                  }),
                  (0, c.jsxs)("button", {
                    type: "button",
                    onClick: n,
                    ...
                    children: [(0, c.jsx)(s.A, { size: 14 }), "Delete"],
                  }),
                ],
              }),
            ],
      ...
      const S = function () {
        var e = b((0, n.useState)(h), 2),
          t = e[0],
          r = e[1],
          a = b((0, n.useState)(j), 2),
          i = a[0],
          s = a[1],
          u = b((0, n.useState)(v), 2),
          d = u[0],
          f = u[1],
          p = b((0, n.useState)(N), 2),
          g = p[0],
          S = p[1],
          k = b((0, n.useState)(null), 2),
          P = k[0],
          O = k[1],
          B = b((0, n.useState)(!1), 2),
          E = B[0],
          T = B[1],
          D = b((0, n.useState)(null), 2),
          z = D[0],
          q = D[1],
          _ = b((0, n.useState)(""), 2),
          I = _[0],
        ...
        var V = (0, n.useCallback)(function () {
            (T(!0),
              (L.current = setTimeout(function () {
                (O(null), T(!1), q(null), M(""), U(""), W(w), K({}));
              }, 240)));
          }, []),
          ...
          ee = (0, n.useCallback)(
            function () {
              I.trim()
                ? ((Q.current += 1),
                  r(function (e) {
                    return [].concat(x(e), [{ id: Q.current, name: I.trim() }]);
                  }),
                  o.Ay.success("Category added"),
                  V())
                : U("Category name is required");
            },
            [I, V],
          ),
            ...
            function () {
              I.trim()
                ? ((Q.current += 1),
                  ...
                  o.Ay.success("Topic added"),
                  V())
                : U("Topic name is required");
            },
            [I, V],
          ),
          ne = (0, n.useCallback)(function (e) {
            (f(function (t) {
              ...
              o.Ay.success("Blog category deleted"));
          }, []),
          ae = (0, n.useCallback)(
            function () {
              I.trim()
                ? ((Q.current += 1),
                  ...
                  o.Ay.success("Blog category added"),
                  V())
                : U("Blog category name is required");
            },
            [I, V],
          ),
          ie = (0, n.useCallback)(function (e) {
            (S(function (t) {
              ...
              o.Ay.success("Pricing plan deleted"));
          }, []),
          se = (0, n.useCallback)(
            function () {
              var e = {};
              if (
                (G.name.trim() || (e.name = "Name is required"),
                G.price.trim()
                  ? (isNaN(Number(G.price)) || Number(G.price) < 0) &&
                    (e.price = "Enter a valid price")
                  : (e.price = "Price is required"),
                G.minutes.trim()
                  ? (isNaN(Number(G.minutes)) || Number(G.minutes) <= 0) &&
                    (e.minutes = "Enter valid minutes")
                  : (e.minutes = "Minutes is required"),
                G.featured.trim() ||
                  (e.featured = "At least one feature is required"),
                ...
                (null !== z
                  ? (S(function (e) {
                      return e.map(function (e) {
                        return e.id === z ? m(m({}, e), r) : e;
                      });
                    }),
                    o.Ay.success("Pricing plan updated"))
                  : ((Q.current += 1),
                    S(function (e) {
                      return [].concat(x(e), [m({ id: Q.current }, r)]);
                    }),
                    o.Ay.success("Pricing plan added")),
                  V());
              }
            },
            [G, z, V],
          ...
          oe = "price" === P,
          ce = !oe && P ? y[P] : null,
          ue = "category" === P ? ee : "topics" === P ? re : ae,
          de = E ? "animate-modal-overlay-out" : "animate-modal-overlay",
          me = E ? "animate-modal-panel-out" : "animate-modal-panel";
        return (0, c.jsxs)("div", {
              ...
              children: [
                (0, c.jsxs)("section", {
                  ...
                  children: [
                    ...
                    (0, c.jsx)("hr", { className: "border-gray-100 mb-4" }),
                    (0, c.jsx)("div", {
                    ...
                    (0, c.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, c.jsx)("button", {
                          type: "button",
                          onClick: function () {
                            return X("blogCategory");
                          },
                          className:
                            "px-4 py-2.5 bg-green-500/60 hover:bg-amber-600 text-white text-base font-medium rounded-lg transition-colors",
                          children: "Add Category",
                        }),
                      ],
                    }),
            ...
            le &&
              (0, c.jsx)("div", {
                ...
                children: (0, c.jsx)("div", {
                  className:
                    "bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 ".concat(
                      me,
                    ),
                  onClick: function (e) {
                          ...
                          (0, c.jsxs)("div", {
                            ...
                            children: [
                              (0, c.jsx)("h3", {
                                className:
                                  "text-xl font-semibold text-gray-900",
                                children: null == ce ? void 0 : ce.title,
                              }),
                              (0, c.jsx)("button", {
                                type: "button",
                                onClick: V,
                          ...
                          (0, c.jsxs)("div", {
                            ...
                            children: [
                              (0, c.jsx)("input", {
                                type: "text",
                                placeholder:
                                  null == ce ? void 0 : ce.placeholder,
                                value: I,
                                onChange: function (e) {
                                  (M(e.target.value), F && U(""));
                                },
                                className:
                                  "w-full px-3 py-2.5 border border-gray-200 rounded-lg text-base text-gray-700 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-amber-400",
                              }),
